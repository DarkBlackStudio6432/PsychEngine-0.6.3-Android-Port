...
#if android
import cpp.Lib; // Para interagir com funções Android
#end
...
class AndroidFunctions
{
    public static function implement(funk:FunkinLua)
    {
        ...
        // Substituindo AndroidTools/Toast
        Lua_helper.add_callback(lua, "isDolbyAtmos", function() return cpp.Lib.load("android", "isDolbyAtmos", false)());
        Lua_helper.add_callback(lua, "isAndroidTV", function() return cpp.Lib.load("android", "isAndroidTV", false)());
        Lua_helper.add_callback(lua, "isTablet", function() return cpp.Lib.load("android", "isTablet", false)());
        Lua_helper.add_callback(lua, "isChromebook", function() return cpp.Lib.load("android", "isChromebook", false)());
        Lua_helper.add_callback(lua, "isDeXMode", function() return cpp.Lib.load("android", "isDeXMode", false)());
        ...
        Lua_helper.add_callback(lua, "setOrientation", function(hint:Null<String>):Void
        {
            ...
            {
                case 'portrait': hint = 'Portrait';
                case 'portraitupsidedown', 'upsidedownportrait', 'upsidedown': hint = 'PortraitUpsideDown';
                case 'landscapeleft', 'leftlandscape': hint = 'LandscapeLeft';
                case 'landscaperight', 'rightlandscape', 'landscape': hint = 'LandscapeRight';
                default: hint = null;
            }
            if (hint == null)
        ...
        Lua_helper.add_callback(lua, "minimizeWindow", function() cpp.Lib.load("android", "minimizeWindow", null)());
        ...
        Lua_helper.add_callback(lua, "showToast", function(text:String, duration:Null<Int>, ?xOffset:Null<Int>, ?yOffset:Null<Int>)
        {
            ...
            cpp.Lib.load("android", "showToast", null)(text, duration, xOffset, yOffset);
        });
